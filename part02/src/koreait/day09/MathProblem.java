...
public class MathProblem {
	// instance 필드 : static이 아닌 형식. 객체가 생성될때마다 다른값을 갖는다.
	private int n1;
	private int n2;
	private char op;	// +, -, *, /
	private boolean isCorrect;		// 사용자 입력한 답이 정답인지 판단
	// static(정적) 필드
	public static final int max_size = 20;		// 문제 최대갯수는 20
	// isCorrect 필드 대신에 ans 필드 추가해서 사용자가 입력한 답을 저장할 수도 있음.
	...
	/*	참고
	 * 	static 메소드는 instance 필드 값과 무관(객체와 연관된 동작이 아니다.)하게 동작하는 메소드
	 * 	instance 메소드는 instance 필드 값과 상관있는 동작하는 메소드
	 */
	...
	public void makeProb() { // 사칙연산 종류별로 적절한 난수 생성하기->문제를 만들어 줍니다.
		...
		case '+':		// op값이 '+' 일때
			...
			break;
		case '-':
			max1=99;max2=49;min1=50;min2=11;	// n1은 50~99, n2는 11~49 : n1>n2가 되도록.
			break;
		case '*':
			max1=77;max2=29;min1=11;min2=11;	// n1은 11~77, n2는 11~29 : n1>n2 곱셈과정을 고려 n2를 작게
			break;
		case '/':
			max1=99;max2=29;min1=41;min2=11;	// n1은 41~99, n2는 11~29 : n1>n2 나눗셈 과정을 고려 n1을 좀더 크게
			break;
