...
public class C34_StringArray {
	public static void main(String[] args) {
		...
		System.out.println("2. korean 배열 요소값이 참조하는 문자열의 길이");
		for(int i = 0; i < koreans.length; i++)
			if(koreans[i] != null)	//***
		...
		// break로 for를 준단하지않고 for를 모두 실행 했을때 같은 문자열이 배열 engKey에 없을 때
		// i = ?
...
/*		
		...
		for(int i = 0; i < engKey.length; i++) { //순착적으로 참조하는 문자열 비교
