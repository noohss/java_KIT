...
public class C69_MyExceptionTest {
	public static void main(String[] args) {
		...
		try {
			...
			if(age < 0 || age > 100) 
				throw new AgeException("나이의 범위는 0~100 입니다.");	// 클래스에서 추가적인 동작이 있을
//			throw new Exception("나이의 범위는 0~100 입니다.");	// 메시지만 바꿀떄
...
class AgeException extends Exception{
	...
	// 사용자가 임의로 메시지를 만들 수 있음.
	public AgeException(String message) {
		super(message);			// Exception의 message 필드를 설
	}
}