...
public class MyClass2 {
	...
	// 커스텀 생성자 정의 연습 : 생성자 메소드는 반드시 1) 클래스 이름과 동일하게 2) 리턴 타입은 없는 형식
	//						3) 접근 한정자는 4가지 모두 가능 : 지금 예시는 기본 package
	//				목적 : 필드 초기화이고 연산식 또는 다른 명령문도 포함 가능.
	...
	// 참고 : 커스텀 생성자를 정의하고 기본 생성자 허용하지 않는 경우가 많다.
...
-> 생성자 메소드 실행으로 객체가 만들어집니다. Random r = new Random();에서 Random()이 생성자 메소드이고
